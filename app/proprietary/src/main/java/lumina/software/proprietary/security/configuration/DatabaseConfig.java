...
@EnableJpaRepositories(
        basePackages = {
            "lumina.software.proprietary.security.database.repository",
            "lumina.software.proprietary.security.repository",
            "lumina.software.proprietary.repository",
            "lumina.software.proprietary.storage.repository",
            "lumina.software.proprietary.workflow.repository"
        })
@EntityScan({
    "lumina.software.proprietary.security.model",
    "lumina.software.proprietary.model",
    "lumina.software.proprietary.storage.model",
    "lumina.software.proprietary.workflow.model"
})
public class DatabaseConfig {
    ...
    public DatabaseConfig(
        ...
        DATASOURCE_DEFAULT_URL =
                "jdbc:h2:file:"
                        ...
                        + "lumina-pdf-DB-2.3.232;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE;MODE=PostgreSQL";
    ...
    private DataSource useDefaultDataSource(DataSourceBuilder<?> dataSourceBuilder) {
        ...
        String overrideUrl = System.getProperty("lumina.datasource.url");
        String url =
