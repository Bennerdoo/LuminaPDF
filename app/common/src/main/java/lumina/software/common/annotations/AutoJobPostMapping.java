package lumina.software.common.annotations;
...
/**
 * Shortcut for a POST endpoint that is executed through the lumina "auto‑job" framework.
 *
 * <p>Behaviour notes:
 *
 * <ul>
 ...
 *       lumina.software.common.service.JobExecutorService JobExecutorService} where it may be
 ...
 *       lumina.software.common.service.TaskManager TaskManager} and can be polled via <code>
