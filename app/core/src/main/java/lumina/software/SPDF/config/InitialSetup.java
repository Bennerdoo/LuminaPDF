...
public class InitialSetup {
    ...
    public void initLegalUrls() throws IOException {
        ...
        if (StringUtils.isEmpty(termsUrl)
                || "https://www.luminapdf.com/terms".equals(termsUrl)
                || "https://luminapdf.com/terms".equals(termsUrl)) {
        ...
        if (StringUtils.isEmpty(privacyUrl)
                || "https://www.luminapdf.com/privacy-policy".equals(privacyUrl)
                || "https://luminapdf.com/privacy-policy".equals(privacyUrl)) {
