...
class BatchTranslator:
    ...
    def get_translation_prompt(self, language_name: str, language_code: str) -> str:
        ...
        return f"""You are a professional translator for Lumina PDF, an open-source PDF manipulation tool.

Translate the following JSON from English to {language_name} ({language_code}) for the Lumina PDF user interface.
