package lumina.software.SPDF.controller.api.misc;
...
import lumina.software.SPDF.controller.api.converters.ConvertPDFToPDFA;
import lumina.software.SPDF.model.api.misc.AddAttachmentRequest;
import lumina.software.SPDF.model.api.misc.DeleteAttachmentRequest;
import lumina.software.SPDF.model.api.misc.ExtractAttachmentsRequest;
import lumina.software.SPDF.model.api.misc.ListAttachmentsRequest;
import lumina.software.SPDF.model.api.misc.RenameAttachmentRequest;
import lumina.software.SPDF.service.AttachmentServiceInterface;
import lumina.software.common.annotations.AutoJobPostMapping;
import lumina.software.common.annotations.api.MiscApi;
...
public class AttachmentController {
    ...
    public ResponseEntity<List<lumina.software.SPDF.model.api.misc.AttachmentInfo>> listAttachments(
            @ModelAttribute ListAttachmentsRequest request) throws IOException {
        try (PDDocument document = pdfDocumentFactory.load(request, true)) {
            List<lumina.software.SPDF.model.api.misc.AttachmentInfo> attachments =
