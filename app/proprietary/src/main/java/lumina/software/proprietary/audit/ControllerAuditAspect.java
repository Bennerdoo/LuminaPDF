package lumina.software.proprietary.audit;
...
import lumina.software.proprietary.service.AuditService;
...
public class ControllerAuditAspect {
    ...
    @Around("@annotation(lumina.software.common.annotations.AutoJobPostMapping)")
