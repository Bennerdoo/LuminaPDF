...
public class ServerCertificateService implements ServerCertificateServiceInterface {
    ...
    private static final String KEYSTORE_ALIAS = "lumina-pdf-server";
    private static final String DEFAULT_PASSWORD = "lumina-pdf-server-cert";

    @Value("${system.serverCertificate.enabled:false}")
    private boolean enabled;

    @Value("${system.serverCertificate.organizationName:lumina-PDF}")
