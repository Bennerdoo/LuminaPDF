package lumina.software.proprietary.workflow.service;
...
import lumina.software.proprietary.storage.model.FilePurpose;
import lumina.software.proprietary.storage.model.ShareAccessRole;
import lumina.software.proprietary.storage.model.StoredFile;
import lumina.software.proprietary.storage.provider.StorageProvider;
import lumina.software.proprietary.storage.provider.StoredObject;
import lumina.software.proprietary.storage.repository.StoredFileRepository;
import lumina.software.proprietary.workflow.dto.ParticipantRequest;
import lumina.software.proprietary.workflow.dto.WetSignatureMetadata;
import lumina.software.proprietary.workflow.dto.WorkflowCreationRequest;
import lumina.software.proprietary.workflow.model.ParticipantStatus;
import lumina.software.proprietary.workflow.model.WorkflowParticipant;
import lumina.software.proprietary.workflow.model.WorkflowSession;
import lumina.software.proprietary.workflow.model.WorkflowStatus;
...
public class WorkflowSessionService {
     ...
     */
    @Transactional(readOnly = true)
    public List<lumina.software.proprietary.workflow.dto.SignRequestSummaryDTO> listSignRequests(
            User user) {
        ...
        return participations.stream()
                .map(
                        p -> {
                            ...
                            lumina.software.proprietary.workflow.dto.SignRequestSummaryDTO dto =
                                    new lumina.software.proprietary.workflow.dto
     ...
     */
    @Transactional(readOnly = true)
    public lumina.software.proprietary.workflow.dto.SignRequestDetailDTO getSignRequestDetail(
            String sessionId, User user) {
        WorkflowSession session = getSession(sessionId);
        WorkflowParticipant participant = getParticipantForUser(session, user);

        lumina.software.proprietary.workflow.dto.SignRequestDetailDTO dto =
                new lumina.software.proprietary.workflow.dto.SignRequestDetailDTO();
        dto.setSessionId(session.getSessionId());
        dto.setDocumentName(session.getDocumentName());
        dto.setOwnerUsername(session.getOwner().getUsername());
    ...
    public void signDocument(
            String sessionId,
            User user,
            lumina.software.proprietary.workflow.dto.SignDocumentRequest request) {
        WorkflowSession session = getSession(sessionId);
        WorkflowParticipant participant = getParticipantForUser(session, user);
