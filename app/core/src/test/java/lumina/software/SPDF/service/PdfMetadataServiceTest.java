...
import lumina.software.common.model.ApplicationProperties.Premium;
import lumina.software.common.model.ApplicationProperties.Premium.ProFeatures;
import lumina.software.common.model.ApplicationProperties.Premium.ProFeatures.CustomMetadata;
...
class PdfMetadataServiceTest {
    ...
    private static final String lumina_PDF_LABEL = "lumina PDF";
    ...
    void testSetDefaultMetadata() {
        ...
        verify(testInfo).setProducer(lumina_PDF_LABEL);
    ...
    void testSetMetadataToPdf_NewDocument() {
        ...
        // Assert
        verify(testInfo).setCreator(lumina_PDF_LABEL);
