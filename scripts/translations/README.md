...
This directory contains Python scripts for managing frontend translations in Lumina PDF. These tools help analyze, merge, validate, and manage translations against the en-GB golden truth file.

## Current Format: TOML

**Lumina PDF uses TOML format for translations** in `frontend/public/locales/{lang}/translation.toml`.
...
- Uses GPT-5 with specialized prompts for Lumina PDF
...
- Specialized system prompts for Lumina PDF translations
