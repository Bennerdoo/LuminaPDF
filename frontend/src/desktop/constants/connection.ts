...
export const lumina_SAAS_URL: string = import.meta.env.VITE_SAAS_SERVER_URL;

// Lumina SaaS backend API server (for team endpoints, etc.)
export const lumina_SAAS_BACKEND_API_URL: string = import.meta.env
...
export const DESKTOP_DEEP_LINK_CALLBACK = "luminapdf://auth/callback";
