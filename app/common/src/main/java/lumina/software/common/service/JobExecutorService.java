package lumina.software.common.service;
...
import lumina.software.common.model.job.JobResponse;
import lumina.software.common.util.ExecutorFactory;
...
public class JobExecutorService {
    ...
    public ResponseEntity<?> runJobGeneric(
        ...
        if (shouldQueue) {
            ...
            Supplier<Object> wrappedWork =
                    () -> {
                        try {
                            ...
                            lumina.software.common.util.JobContext.setJobId(capturedJobIdForQueue);
                            log.debug(
                            ...
                            lumina.software.common.util.JobContext.clear();
                        }
                    };
            ...
            executor.execute(
                    () -> {
                        try {
                            ...
                            lumina.software.common.util.JobContext.setJobId(capturedJobId);
                            log.debug(
            ...
            try {
                ...
                lumina.software.common.util.JobContext.setJobId(jobId);
                ...
                if (e instanceof IllegalArgumentException
                        || cause
                                instanceof
                                lumina.software.common.util.ExceptionUtils.BaseAppException
                        || cause
                                instanceof
                                lumina.software.common.util.ExceptionUtils
    ...
    private <T> T executeWithTimeout(Supplier<T> supplier, long timeoutMs)
        ...
        String currentJobId = lumina.software.common.util.JobContext.getJobId();

        java.util.concurrent.CompletableFuture<T> future =
                java.util.concurrent.CompletableFuture.supplyAsync(
                        () -> {
                            if (currentJobId != null) {
                                lumina.software.common.util.JobContext.setJobId(currentJobId);
                            }
                            try {
                                return supplier.get();
                            } finally {
