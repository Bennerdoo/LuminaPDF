...
This guide explains how to set up Windows code signing for Lumina-PDF desktop application builds.
...
Get-AuthenticodeSignature "./src-tauri/target/release/bundle/msi/Lumina-PDF_*.msi"
```
...
**Windows (PowerShell):**
```powershell
Get-AuthenticodeSignature "Lumina-PDF-windows-x86_64.exe"
Get-AuthenticodeSignature "Lumina-PDF-windows-x86_64.msi"
```
