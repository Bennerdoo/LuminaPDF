...
import lumina.software.SPDF.model.api.general.MergePdfsRequest;
...
import lumina.software.common.util.PdfErrorUtils;
...
public class MergeController {
    ...
    private static MultipartFile[] reorderFilesByProvidedOrder(
        ...
        String[] desired =
                lumina.software.common.util.RegexPatternUtils.getInstance()
