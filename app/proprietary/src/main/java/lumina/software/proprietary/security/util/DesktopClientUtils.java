package lumina.software.proprietary.security.util;
...
public class DesktopClientUtils {
    ...
    public static boolean isDesktopClient(HttpServletRequest request) {
        ...
        boolean haslumina = userAgentLower.contains("luminapdf-desktop");
        boolean hasElectron = userAgentLower.contains("electron");
        boolean isDesktop = hasTauri || haslumina || hasElectron;
