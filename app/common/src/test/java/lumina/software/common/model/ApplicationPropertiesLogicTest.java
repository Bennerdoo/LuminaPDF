...
import lumina.software.common.model.ApplicationProperties.Driver;
...
class ApplicationPropertiesLogicTest {
    ...
    void tempFileManagement_defaults_and_overrides() {
        ...
        String expectedBase =
                Paths.get(java.lang.System.getProperty("java.io.tmpdir"), "lumina-pdf").toString();
    ...
    void enterprise_metadata_defaults() {
        ...
        assertEquals("lumina-PDF", eMeta.getCreator());
        assertEquals("lumina-PDF", eMeta.getProducer());
    }
    ...
    void premium_metadata_defaults() {
        ...
        pMeta.setCreator("");
        pMeta.setProducer("");
        assertEquals("lumina-PDF", pMeta.getCreator());
        assertEquals("lumina-PDF", pMeta.getProducer());
    }
