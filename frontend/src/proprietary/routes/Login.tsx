...
export default function Login() {
  ...
  const AUTO_LOGIN_ATTEMPTS_KEY = "lumina_sso_auto_login_attempts";
  const AUTO_LOGIN_ERRORS_KEY = "lumina_sso_auto_login_errors";
  const AUTO_LOGIN_LOGOUT_KEY = "lumina_sso_auto_login_logged_out";
  ...
  useEffect(() => {
    const fetchProviders = async () => {
      try {
        ...
        // The backend provides paths like "/oauth2/authorization/google" or "/saml2/authenticate/lumina"
  ...
  // Set document meta
  useDocumentMeta({
    title: `${t("login.title", "Sign in")} - Lumina PDF`,
    description: t(
      "app.description",
      "The Free Adobe Acrobat alternative (10M+ Downloads)",
    ),
    ogTitle: `${t("login.title", "Sign in")} - Lumina PDF`,
    ogDescription: t(
      "app.description",
      "The Free Adobe Acrobat alternative (10M+ Downloads)",
    ),
