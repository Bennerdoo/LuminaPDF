...
import lumina.software.SPDF.config.EndpointConfiguration.EndpointAvailability;
import lumina.software.SPDF.config.InitialSetup;
import lumina.software.SPDF.controller.api.security.TimestampController;
import lumina.software.common.annotations.api.ConfigApi;
import lumina.software.common.configuration.AppConfig;
import lumina.software.common.model.ApplicationProperties;
import lumina.software.common.service.ServerCertificateServiceInterface;
...
public class ConfigController {
    ...
    private final lumina.software.common.service.LicenseServiceInterface licenseService;
    private final lumina.software.SPDF.config.ExternalAppDepConfig externalAppDepConfig;
    ...
    public ConfigController(
            ...
            @org.springframework.beans.factory.annotation.Autowired(required = false)
                    lumina.software.common.service.LicenseServiceInterface licenseService,
            lumina.software.SPDF.config.ExternalAppDepConfig externalAppDepConfig) {
    ...
    public ResponseEntity<Map<String, Object>> getAppConfig() {
        ...
        try {
            ...
            if ((frontendUrl == null || frontendUrl.isBlank())
                    && Boolean.parseBoolean(System.getProperty("lumina_PDF_TAURI_MODE", "false"))) {
