package lumina.software.proprietary.security.config;
...
public class EnterpriseEndpointAspect {
    ...
    @Around(
            "@annotation(lumina.software.proprietary.security.config.EnterpriseEndpoint) || @within(lumina.software.proprietary.security.config.EnterpriseEndpoint)")
