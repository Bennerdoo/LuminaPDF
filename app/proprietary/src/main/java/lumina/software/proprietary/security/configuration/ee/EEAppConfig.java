package lumina.software.proprietary.security.configuration.ee;

import static lumina.software.proprietary.security.configuration.ee.KeygenLicenseVerifier.License;
...
import lumina.software.common.model.ApplicationProperties.EnterpriseEdition;
    ...
    public void migrateEnterpriseSettingsToPremium(ApplicationProperties applicationProperties) {
        ...
        if (enterpriseMetadata != null && premiumMetadata != null) {
            ...
            if ((premiumMetadata.getCreator() == null
                            || "lumina-PDF".equals(premiumMetadata.getCreator()))
                    && enterpriseMetadata.getCreator() != null
                    && !"lumina-PDF".equals(enterpriseMetadata.getCreator())) {
            ...
            if ((premiumMetadata.getProducer() == null
                            || "lumina-PDF".equals(premiumMetadata.getProducer()))
                    && enterpriseMetadata.getProducer() != null
                    && !"lumina-PDF".equals(enterpriseMetadata.getProducer())) {
