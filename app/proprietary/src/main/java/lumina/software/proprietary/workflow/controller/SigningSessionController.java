package lumina.software.proprietary.workflow.controller;
...
import lumina.software.proprietary.workflow.dto.CertificateInfo;
import lumina.software.proprietary.workflow.dto.CertificateValidationResponse;
...
import lumina.software.proprietary.workflow.service.CertificateSubmissionValidator;
import lumina.software.proprietary.workflow.service.SigningFinalizationService;
import lumina.software.proprietary.workflow.service.WorkflowSessionService;
...
public class SigningSessionController {
    ...
    public ResponseEntity<?> listSessions(Principal principal) {
        ...
        try {
            ...
            List<lumina.software.proprietary.workflow.model.WorkflowSession> sessions =
                    workflowSessionService.listUserSessions(user);
            List<lumina.software.proprietary.workflow.dto.WorkflowSessionResponse> responses =
                    sessions.stream()
                            .map(
                                    lumina.software.proprietary.workflow.util.WorkflowMapper
                                            ::toResponse)
    ...
    public ResponseEntity<?> createSession(
        ...
        try {
            ...
            return ResponseEntity.ok(
                    lumina.software.proprietary.workflow.util.WorkflowMapper.toResponse(session));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> getSession(
        ...
        try {
            ...
            return ResponseEntity.ok(
                    lumina.software.proprietary.workflow.util.WorkflowMapper.toResponse(
    ...
    public ResponseEntity<?> signDocument(
            @PathVariable("sessionId") @NotBlank String sessionId,
            @ModelAttribute lumina.software.proprietary.workflow.dto.SignDocumentRequest request,
            Principal principal) {
        workflowSessionService.ensureSigningEnabled();
        if (principal == null) {
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body("Authentication required");
