  ...
  const handleDownload = async () => {
    ...
    try {
      await saveOperationResults({
        ...
        getStub: (fileId) => selectors.getluminaFileStub(fileId as FileId),
        markSaved: (fileId, savedPath) => {
          const stub = selectors.getluminaFileStub(fileId as FileId);
          fileActions.updateluminaFileStub(fileId as FileId, {
