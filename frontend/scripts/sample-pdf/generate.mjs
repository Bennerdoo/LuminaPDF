...
/**
 * lumina PDF Sample Document Generator
 *
 ...
 * for users to experiment with lumina PDF's features.
 */
...
async function generatePDF() {
  console.log("🚀 Starting lumina PDF sample document generation...\n");
  ...
  console.log("\n🎉 Done! Sample PDF is ready for use in lumina PDF.\n");
}
