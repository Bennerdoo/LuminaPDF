          ...
          <Stack gap="md">
            ...
            <div>
              <TextInput
                ...
                description={t(
                  ...
                  "Base directory for temporary files (leave empty for default: java.io.tmpdir/lumina-pdf)",
                )}
                ...
                placeholder="Default: java.io.tmpdir/lumina-pdf"
                disabled={!loginEnabled}
              />
            </div>
            ...
            <div>
              <TextInput
                ...
                value={settings.tempFileManagement?.prefix || "lumina-pdf-"}
                onChange={(e) =>
                  setSettings({
                    ...settings,
                    tempFileManagement: {
