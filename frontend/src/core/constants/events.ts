...
export const SERVER_LICENSE_REQUEST_EVENT = "lumina:server-license-requested";
export const UPGRADE_BANNER_TEST_EVENT = "lumina:upgrade-banner-test";
export const UPGRADE_BANNER_ALERT_EVENT = "lumina:upgrade-banner-alert";
export const START_TOUR_EVENT = "lumina:start-tour";
export const TOUR_STATE_EVENT = "lumina:tour-state";
