...
import lumina.software.common.service.PdfSigningService;
import lumina.software.common.service.ServerCertificateServiceInterface;
import lumina.software.proprietary.workflow.dto.CertificateSubmission;
            ...
            try {
                ...
                try {
                    ClassPathResource logoRes =
                            new ClassPathResource("static/images/lumina-logo-white.png");
                    ...
                    log.debug(
                            "Could not load lumina-PDF logo for summary page: {}", e.getMessage());
                    cs.setNonStrokingColor(Color.WHITE);
                    cs.beginText();
                    cs.setFont(fontBold, 13);
                    cs.newLineAtOffset(logoX, PAGE_H - 28);
                    cs.showText("Lumina PDF");
                    cs.endText();
                }
                ...
                String footerText = "Generated by Lumina-PDF";
