package lumina.software.proprietary.security.saml2;
...
import lumina.software.proprietary.security.oauth2.TauriOAuthUtils;
...
public class CustomSaml2AuthenticationSuccessHandler
    ...
    private static final String SPA_REDIRECT_COOKIE = "lumina_redirect_path";
    ...
    public void onAuthenticationSuccess(
        ...
        if (principal instanceof CustomSaml2AuthenticatedPrincipal saml2Principal) {
            ...
            if (userExists) {
                lumina.software.proprietary.security.model.User user =
